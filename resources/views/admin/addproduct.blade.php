...
@section('halaman')
    <div class="relative overflow-x-auto">
        <form id="product" name="product" action="/add/ptest" enctype="multipart/form-data" method="post">
            @csrf
            <div class=" mt-5">
                <input
                    ...
                    aria-describedby="user_avatar_help" id="poto" name="poto" type="file">
                <input class="mr-2" class="w-96" type="text" id="title" name="title" placeholder="Title"
